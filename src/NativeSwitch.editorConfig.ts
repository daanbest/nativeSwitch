import { NativeSwitchPreviewProps } from "../typings/NativeSwitchProps";
...
export function getProperties(
    _values: NativeSwitchPreviewProps,
...
export function getPreview(values: NativeSwitchPreviewProps, isDarkMode: boolean): PreviewProps {
    const label: PreviewProps = {
        type: "Container",
        borders: false,
        children: [
            { type: "Container", padding: 3, children: [] },
            {
                type: "Text",
...
// export function check(_values: NativeSwitchPreviewProps): Problem[] {
...
// export function getPreview(values: NativeSwitchPreviewProps, isDarkMode: boolean, version: number[]): PreviewProps {
...
// export function getCustomCaption(values: NativeSwitchPreviewProps, platform: Platform): string {
//     return "NativeSwitch";
// }
